...
Published as the [latest stable v2.2.4](https://github.com/CRSD-Lau/deep-live-cam/releases/tag/v2.2.4) at 2026-09-07T01:55:44Z. [Public verification](PUBLIC_RELEASE_VALIDATION.md) passed for all 47 fresh unauthenticated downloads and the annotated tag at the frozen source commit.
...
The release attachments are the immutable prepublication evidence snapshot. These later public-readback receipts record publication without changing that 47-file asset set or rewriting earlier automated or owner reports.
